...
public class BoardTest {
    ...
    /**
     * A position to test machine player.
     */
    static final Piece[][] BOARD5 = {
            {EMP, EMP, EMP, EMP, EMP, EMP, EMP, EMP},
            {EMP, EMP, EMP, EMP, EMP, EMP, EMP, EMP},
            {EMP, EMP, BP, WP, WP, BP, EMP, EMP},
            {EMP, EMP, EMP, WP, WP, BP, BP, EMP},
            {EMP, EMP, EMP, EMP, BP, WP, WP, EMP},
            {EMP, EMP, EMP, WP, BP, EMP, EMP, EMP},
    ...
    public void testContiguous1() {
        ...
        assertFalse("Board 4 black contiguous?", b4.piecesContiguous(BP));
        assertFalse("Board 4 game over", b4.gameOver());
        b4.makeMove(mv("b1-b4"));
    ...
    public void tesLegal() {
        Board b4 = new Board();
        List<Move> legalMoves = b4.legalMoves(null);
        assertEquals(36, legalMoves.size());
    }
